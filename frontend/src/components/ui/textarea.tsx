  ...
  ({ label, error, helperText, className, id, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        {label && (
          <label htmlFor={textareaId} className="block text-sm font-medium text-fg-2 mb-1.5">
            {label}
        ...
        <textarea
          ...
          className={cn(
            ...
            'focus:ring-2 focus:ring-accent focus:border-transparent outline-none transition-shadow resize-vertical min-h-[100px]',
