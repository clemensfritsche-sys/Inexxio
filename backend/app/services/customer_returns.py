...
def request_return(db: Session, order_object_id: int, customer_id: int, reason: str | None) -> Order:
    ...
    st = return_status(db, order, sale, customer_id)
