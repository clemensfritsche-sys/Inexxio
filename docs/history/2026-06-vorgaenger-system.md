# Das Vorgänger-System (Stand Juni 2026) – ARCHIV

> **Dieser Text beschreibt ein System, das es nicht mehr gibt.**
>
> Er stand bis August 2026 in `CLAUDE.md` und ist dort das gewachsene Protokoll dessen,
> was **vor** dem Basis-Neuaufbau gebaut wurde: Prozessschritte am Artikel, Instanzen mit
> Mengen-Skalar, `quality`/`disposition` als zwei Achsen, Reservierungs-Map, Verkauf/Shop,
> Dokumente, KI, Logistik. Der Neuaufbau hat die Prozesslogik ersatzlos entfernt und auf
> dem Einzelinstanz-Modell neu aufgesetzt (`PROCESS_CORE.md`); die daran hängenden Bereiche
> sind mit dem Aufräumen im August 2026 gelöscht (`docs/attic.md`).
>
> **Nicht als Vorlage verwenden.** Wertvoll ist er als Entscheidungsprotokoll: die Fragen,
> die hier gestellt und beantwortet wurden, stellen sich beim Wiederaufbau erneut – die
> Antworten müssen aber neu gegeben werden, weil das Datenmodell darunter ein anderes ist.
>
> Ausgelagert, weil `CLAUDE.md` von **jeder** Sitzung als Erstes gelesen wird: 5.700 Zeilen
> über ein nicht mehr existierendes System kosten dort mehr, als sie nützen.
